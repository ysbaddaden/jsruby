...
var rubyTestEnv = function(start, options)
{
  ...
  test.rb_same = function(expected, rb_code)
  {
  ...
  test.rb_nil = function(rb_code) {
    test.rb_same(Ruby.objects['nil'], rb_code);
  };

  test.rb_true = function(rb_code) {
    test.rb_same(Ruby.objects['true'], rb_code);
  };

  test.rb_false = function(rb_code) {
    test.rb_same(Ruby.objects['false'], rb_code);
  };
