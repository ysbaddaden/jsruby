...
var rb_class, rb_classes = [], YARVInstructionSequence;
...
function rb_bool(v) {
  return v ? rb_objects['true'] : rb_objects['false'];
}

exports.compile = function(str, callback)
{
  var cmd = 'echo "' + str.replace('"', '\"') + '" | ruby ' + __dirname + '/compile.rb';
  ...
  child_process.exec(cmd, {}, function(error, stdout, stderr)
  {
    ...
    var iseq = new YARVInstructionSequence(json);
    callback(iseq);
  });
}
